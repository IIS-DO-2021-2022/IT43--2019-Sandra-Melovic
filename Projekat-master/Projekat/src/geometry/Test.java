...
public class Test {
	...
	public static void main(String[] args) {
		...
		System.out.println("X p1 je: " + p1.getX());
		System.out.println("Y p1 je: " + p1.getY());
		System.out.println("Selected p1 je: " + p1.isSelected());
		
		Point p2= new Point();
		p2.setX(13);
		p2.setY(11);
		
		System.out.println("Udaljenost izmedju x i y je: " + p1.distance(p2.getX(),p2.getY()));
		p1.setX(p2.getX());
		System.out.println("Udaljenost izmedju x i y je: " + p1.distance(p2.getX(),p2.getY()));
		...
		System.out.println("X start point je: " + l1.getStartPoint().getX());
		...
		l2.setEndPoint(p2);
		System.out.println("Y endPoint l2 je: " + l2.getEndPoint().getY());
